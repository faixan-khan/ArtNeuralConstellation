...
#compute z statistic human art drawn after 1800 vs. AI art
...
def main():
    ...
    df_real=df_real[(df_real["year"]>1800)]#after
    ...
    for idx,element in enumerate(visual_elements_15):
        ...
        if z_score<z_left or z_score>z_right:
             ...
             ax[idx].set_title(element+" with z: "+str(round(z_score,2)),y=0.6,fontsize=7.5)
    ...
    print("complete...")
    plt.savefig("./diff_rg_plt_1800/after_1800.png")
